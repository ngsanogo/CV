...
position: Data Product Owner / Chef de projet Data
...
linkedin: ngsanogo
github: ngsanogo
aboutme: "Fort d'une expertise approfondie en ingénierie des données et d'une maîtrise dans la conception d'entrepôts de données, le développement de processus ETL/ELT et la gestion ainsi que l'analyse de données, je suis prêt à mettre mes compétences au service de votre entreprise. Je suis profondément convaincu que mes solides compétences techniques et de gestion de projet, mon expérience professionnelle diversifiée et mes qualités personnelles me permettront d'apporter une valeur ajoutée significative à votre entreprise."
headcolor: 414141
